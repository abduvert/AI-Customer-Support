  ...
  return (
    <div className="flex flex-col min-h-screen bg-cyan-600 font-mono">
      ...
      <div className="flex-grow flex flex-col items-center justify-center pt-16 px-4 lg:px-6 xl:px-8">
        ...
        Navigating life across university campuses? Let our smart AI chatbot guide you through every challenge and opportunity, from academics to campus life. Your comprehensive support is just a click away! <br></br>Currently working: COMSATS Connie </p>
        <Link href="/Chatbot">
